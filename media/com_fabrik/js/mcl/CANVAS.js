		...
		setupMouse : function(){
			$(this.ctxEl).addEvents({	
				...
				mousemove : function(e)
				{
					...
					var i = CANVAS.findTarget(p);
					if(i)
					{
						if(i.fullid != CANVAS.lastMouseOverTarget)
						{
							i.fireEvent('mouseover',p);
							if(CANVAS.lastMouseOverTarget)
							{
								CANVAS.fromPath(CANVAS.lastMouseOverTarget).fireEvent('mouseout',p);
							}
							CANVAS.lastMouseOverTarget = i.fullid;
						}
						else
						{
							i.fireEvent('mousemove',p);
						}
					}
					else
					{
