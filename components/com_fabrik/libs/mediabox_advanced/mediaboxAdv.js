...
// MEDIABOX FORMATING
			...
			// $$$ hugh - use of toString above has already encoded spaces as %20 so we need
			// to undo that before running it through encodeURI().
			URL = encodeURI(URL.replace("%20"," ")).replace("(","%28").replace(")","%29");
