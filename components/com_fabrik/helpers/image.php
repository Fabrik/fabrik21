...
class image
{
	...
	{
		// $$$ hugh - can't use getimagesize() as it might be Private S3 file
		// should prolly make this a storage method, but for now just look at the extension.
		/*
...
class imageGD2 extends imageGD
{
	...
	function resize($maxWidth, $maxHeight, $origFile, $destFile)
	{
		...
		/* If an image was successfully loaded, test the image for size*/
		if ($img) {
			// $$$ hugh - handle transparency, see ...
			// http://fabrikar.com/forums/showthread.php?p=122950#post122950
