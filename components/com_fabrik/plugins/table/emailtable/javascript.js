var fbTableEmail = FbTablePlugin.extend({
	...
	makePopUp: function() {
		var url = this.options.liveSite + "index.php?option=com_fabrik&controller=table.emailtable&task=popupwin&tmpl=component&iframe=1&id="+this.tableid+"&renderOrder="+this.options.renderOrder;
