...
class FabrikModelFbactivityfeed extends FabrikModelElement {

	var $_pluginName = 'fbactivityfeed';
	...
	function render($data, $repeatCounter = 0)
	{
		...
		$str = FabrikHelperHTML::facebookGraphAPI($params->get('opengraph_applicationid'), $params->get('fbactivity_locale', 'en_US'));
	...
	{
		FabrikHelperHTML::script('javascript.js', 'components/com_fabrik/plugins/element/fbactivityfeed/', false);
	}
