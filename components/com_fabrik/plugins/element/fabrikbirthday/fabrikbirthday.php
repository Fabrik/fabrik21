...
class FabrikModelFabrikbirthday extends FabrikModelElement {

	var $_pluginName = 'fabrikbirthday';
	...
	{
		FabrikHelperHTML::script('javascript.js', 'components/com_fabrik/plugins/element/fabrikbirthday/', false);
	}
