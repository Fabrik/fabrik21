...
class FabrikModelTwitter_profile extends FabrikModelElement {

	var $_pluginName = 'twitter_profile';
	...
	{
		FabrikHelperHTML::script('javascript.js', 'components/com_fabrik/plugins/element/twitter_profile/', false);
	}
