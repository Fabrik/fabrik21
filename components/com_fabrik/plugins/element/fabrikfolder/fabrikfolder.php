...
class FabrikModelFabrikFolder extends FabrikModelElement {

	var $_pluginName = 'folder';
...
<div id="page-<?php echo $this->_name;?>" class="elementSettings"
	...
	{
		FabrikHelperHTML::script('javascript.js', 'components/com_fabrik/plugins/element/fabrikfolder/', false);
	}
