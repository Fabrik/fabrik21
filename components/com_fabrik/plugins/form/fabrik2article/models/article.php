...
//		 *
    ...
    function updateFabrikData() {
        if ($this->_isNew && $this->_articleId > 0) {
            ...
            $tableModel = $this->_formModel->getTableModel();
            $tableModel->_oForm =& $this->_formModel;
            $primaryKey = $tableModel->_shortKey();
            ...
            $tableModel->storeRow($this->_formModel->_formData, $this->_formModel->_fullFormData['rowid']);
        }
    }
