...
class FabrikModelfabrikclone extends FabrikModelFormPlugin {
	...
	private function _process(&$params, &$formModel)
	{
		...
		if ($clone_times_field_id != '') {
			...
			if ($clone_batchid_field_id != '') {
				...
				$tableModel->storeRow($formModel->_formData, $formModel->_fullFormData['rowid']);
			}
