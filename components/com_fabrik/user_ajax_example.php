 ...
 * your custom JS code:
 *
 * index.php?option=com_fabrik&format=raw&controller=plugin&c=plugin&task=userAjax&method=userExists&username=" + myUsername;
 *
 ...
 *	 var url = "index.php?option=com_fabrik&format=raw&controller=plugin&c=plugin&task=userAjax&method=userExists&username=" + myUsername;
 *	 new Ajax(url, {
